...
import { KeywordResearchStateSchema, keywordFamily } from "./specs/keywords";
...
const keywordWorkflow = defineWorkflow({
  ...
  researchInstructions:
    "Discover current demand, validate intent, map existing pages, and identify page-ownership gaps using current Executor evidence.",
});
